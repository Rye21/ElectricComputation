						...
						<tbody>
							<tr>
								<td colspan="7" style="border-style:solid"><br>
									<p style="color:blue;font-size:18px;" class="space"><span style="color:red;font-size:20px;">*CH = 2400/2600: 489*</span>   Formula:   (Ceiling Height <span style="color:red">-</span>  Window/Door/Opening Height) <span style="color:red">+/-</span> (Requested Height <span style="color:red">-</span> Standard Height)<span style="color:red"> =  Space/Allowance </span> </p>
								</td>
							</tr>
							<?php
							 function room() {
							...
							<tr>
								<td style="width:250px;text-align:center;vertical-align:middle;background-color:">
									 <label style="font-size:18px;color:black;color:red">Requested Height<br> Other Than Standard Height<br>(standard H=2100):</label><br>
										<input type="" name="rsh" id="rsh" value="" style="font-size:30px;height:100px;width:150px;color:red;text-align:center" onkeyup="setTimeout(compute1, 100)" onkeypress="setTimeout(compute1, 100)"   /><br>
								...
								<td style="text-align:center;vertical-align:middle;background-color:">
									<label style="font-size:18px;color:black"class="space">Ceiling Height:<span style="color:red;font-size:20px" class="space"> + 30</span></label><br>
										<select  style="height:40px;font-size:25px;text-align:center;width:150px;color:blue" id="CH7"  name="CH7" class="CH7"required="required"  onchange="setTimeout(compute1, 100)" onclick="setTimeout(compute1, 100)" >
											...
											<option value="2230">2200</option>
											<option value="2330">2300</option>
									...
									<label style="font-size:18px;color:black" class="space">			Elevated Height</label><br>	
										<select   style="font-size:25px;text-align:center;height:40px;width:300px;color:blue;margin:auto;" id="wdh"  name="wdh" required="required" onchange="setTimeout(compute1, 100)" onclick="setTimeout(compute1, 100)" onkeypress="setTimeout(compute1, 100)" />
											<option value=""></option>
				...
				<form id="myForm3">	
					<table class="table table-condensed" border="2"	 style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<tbody>
							...
							<tr>
								<td style="width:250px;text-align:center;vertical-align:middle;background-color:">
									 <label style="font-size:18px;color:black;color:red">Requested Height<br> Other Than Standard Height<br>(standard H=2200):</label><br>
										<input type="" name="rsh2" id="rsh2" value="" style="font-size:30px;height:100px;width:150px;color:red;text-align:center" onkeyup="setTimeout(compute2, 100)" onkeypress="setTimeout(compute2, 100)"   /><br>
