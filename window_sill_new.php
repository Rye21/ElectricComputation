							...
							?>	
								...
								<td style="vertical-align:middle;width:500px">
									<div class="container-fluid">
										...
										<br>
										<label style="font-size:18px;color:black">Last 2 Digit of Window Serial:</label>
											<input type="number" name="ws1" id="ws1" value="" style="height:50px;width:42%;font-size:25px;color:blue;text-align:center" />
								...
								<td class="" colspan="5" style="text-align:center;">
									...
									<input type="" name="height" id="height" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
					...
					<form id="myForm4">	
						...
						<center><table id="table4" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
							...
							<tr>
								...
								<td class="" colspan="5" style="text-align:center;">
									<label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
										<input type="hidden" name="height4" id="height4" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
