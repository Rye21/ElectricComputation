						...
						<tbody>
							...
							<form method="post" action="">
								...
								<label style="font-size:25px;color:black">Customer Code:</label>
									<input type="text" name="code_number" id="code_number" onkeypress="kva_check1()" onKeyup="kva_check1()" onblur="kva_check1()" onmousemove="kva_check1()"   style="font-size:20px;width:200px;text-align:center;color:red;" maxlength="12"   />
							...
							<!--<div id="content"></div>-->
								...
								<td class="form-inline" colspan="6" style="text-align:center;vertical-align:middle;">										  					 											
									...
									<label style="font-size:25px;color:black;" class="space">		Result:</label>									
										<input type="text" id="demo" name="demo"  style="width:530px;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;" disabled>
							...
							<tr>
								...
								<input align="center" type="text" id="demo2" name="demo2"   style="width:220px;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
