			...
			<div id="tab2" class="tab-pane fade in active">
					...
					<center>
						<div class="row">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="http://hrdapps33/denkicomputation/window_new_test1.php"><button style=";border-radius:20%;border-color:gray" type='button' id="show1" name="show1" ><img src="assets/img/low.PNG" id="sample" alt="" style="width:250px;height:250px;border-radius:20%;" /></button></a>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<center><table id="table" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
						...
						<form id="myForm1">			
										<label style="font-size:18px;color:black" class="space">Item:			     </label>
											<select  style="height:50px;width:60%;font-size:20px;text-align:center;color:blue" class="heightitem" id="heightitem"  name="heightitem" required="required" onchange="setTimeout(compute1, 10)" onkeypress="setTimeout(compute1, 10)">
												<option value=""></option>
