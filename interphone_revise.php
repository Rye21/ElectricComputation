...
alert('NO NEED TO COMPUTE !! ITS 10kW ( below ) !!');
    	...
    	<script>
			...
			/////////////////////check_OptionPicking///////////////////
				...
				if (joutou > date && (interphone == 'MT61' ||  interphone == 'MT62' || interphone == 'MT63' || interphone == 'MT72' || interphone == 'MT81' || interphone == 'MT82' || interphone == 'MT83')) {
			...
			function checkemailAvailability1() {
				...
				/* jQuery.ajax({
				url: "check1/check_composition2.php",
				data:'interphone2='+$("#interphone2").val(),
				//'&interphone2='+$("#interphone2").val(),
				type: "POST",
				success:function(data){
				$("#email-availability-status").html(data);
				var number1 = document.getElementById("item_name2").value = document.getElementById("email-availability-status").innerHTML;
				var number2 = document.getElementById("item_name2").value;
				var str = number2;
				var str1 = str.substring(0, str.length - 1);
				var C = document.getElementById("item_name2").value = str1; */
				//var strArray = C.split(",");
			...
			/* 	$("#loaderIcon").hide();
				...
				/* else if (number2 == 'MT82'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT82.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT83'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT83.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT71'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT71.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT91'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT91.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT92'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT92.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT101'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT101.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT102'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT102.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT103'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT103.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT104'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT104.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == 'MT105'){
					document.getElementById("imageDiv").innerHTML = '<img src="interphone_pattern/MT105.PNG" style="height:150px;width:300px;"/>';
				} else if (number2 == ''){
					
				}  *//* else {
					//document.getElementById('imageDiv').innerHTML = '<img src="interphone_pattern/MT105.PNG" />';
				} */
					...
					<table class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						<thead>
							<div data-role="header" class="" id="FireAlarmAboveWindow">
								<th colspan="6"><h1>INTERPHONE COMPOSITION CHECKING SYSTEM</h1></th>					
							</div>
						</thead>
						<tbody>
							<tr>	
							...
							<div class="container-fluid ">
								...
								<div class="col-sm-4">	
									...
									<label style="font-size:20px;color:black" class="space">Joutou Plan:    	 </label>
										<input type="" name="joutou" id="joutou"   style="font-size:20px;width:150px;text-align:center;color:red;background-color:#b6bdc6;"  readonly="readonly"  />
							...
							<div class="col-sm-4">		
											...
											<input type="text" id="demo" name="demo"  value="" style="text-align:center;width:200px;font-size:30px;font-weight:bold;border:;background-color:#b6bdc6;" disabled>
							...
							<center><p id="demo2" name="demo2"  class="blink_me" style="width:800px;font-size:30px;font-weight:bold;border:none;color:red;text-align:center;" disabled ></p></center>
