...
$sql = "UPDATE views SET visits = visits+1,date_updated = '$dateUpdate' WHERE id = 2";
$conn->query($sql);

$sql = "SELECT visits FROM views WHERE id = 2";
...
<head>
	...
	<title>BUNDENBAN & JBDA KABE FUKASU</title>
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							<li class="active"><a data-toggle="tab" href="https://www.w3schools.com/bootstrap/tryit.asp?filename=trybs_theme_band_complete&amp;stacked=h#tab3">Bundenban Kabe Fukasu</a></li>
      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<center><label class="head">BUNDENBAN KABE FUKASU IN IRISUMI DOOR/WINDOW COMPUTATION</label></center>
							...
							<table class="table table-condensed" border="2" style="background-color:aliceblue;width:100%;border-style:solid">
								<thead>
									<div data-role="header">
										<th colspan="7">
											<h1>JB-DA Kabe Fukasu Computation</h1>
										</th>
									</div>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td style="text-align:center;vertical-align:middle;">
											...
											</select><span style="color:red;font-size:20px" class="space"> + 30</span>
											<!--<br><span style="color:red;font-size:15px" class="space">OR</span><br>
									<label style="font-size:18px;color:black" class="space">Req. Ceiling Height:</label>	<br>-->
											<input type="text" name="CH3" id="CH3" class="CH3 hide" value="" style="height:40px;font-size:25px;width:400px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 100)" onkeypress="setTimeout(compute1, 100)" />
										</td>
										...
										<td style="width:900px;text-align:center;vertical-align:middle;">
											<label style="font-size:18px;color:black" class="space">Window/Door Serial</label><br>
											...
											</select><br><span style="color:red;font-size:35px" class="space"> + </span><br>
											...
											<input type="text" name="wdhB" id="wdhB" class="wdhB hide" value="" style="font-size:20px;width:150px;text-align:center" />
											...
											<input type="text" name="wdhD" id="wdhD" class="wdhD hide" value="" style="font-size:20px;width:150px;text-align:center" />
											<label style="font-size:18px;color:black" class="space">Elevated Height</label><br>
											<input type="number" name="woh2" id="woh2" value="" style="font-size:25px;height:40px;width:150px;text-align:center;color:blue" onkeyup="setTimeout(compute1, 100)" onkeypress="setTimeout(compute1, 100)" /><br><br>
									...
									<label style="font-size:18px;color:black">Window Opening Height:</label>
										...
										<td style="vertical-align:middle;font-size:35px;font-weight:bold;color:red;text-align:center;"> =
										<td style="padding:auto;width:200px;text-align:center;vertical-align:middle;">
						...
						<form id="myForm3">
							<table class="table table-condensed" border="2" style="background-color:aliceblue;width:100%;border-style:solid">
								<thead>
									<div data-role="header">
										<th colspan="7">
											<h1>Bundenban Kabe Fukasu in Irisumi Door/Window</h1>
										</th>
									</div>
								</thead>
								<tbody>
									...
									<label style="font-size:18px;color:black" class="space">Req. Ceiling Height:</label>	<br>-->
										...
										<td style="width:400px;text-align:center;vertical-align:middle;">
											...
											</select><br><span style="text-align:center;color:red;font-size:35px" class="space"> + </span><br>
											...
											<input type="text" name="wdh3" id="wdh3" class="wdh3 hide" value="" style="font-size:20px;width:150px;text-align:center" />
											...
											<input type="text" name="wdh5" id="wdh5" class="wdh5 hide" value="" style="font-size:20px;width:150px;text-align:center" />
											<label style="font-size:18px;color:black" class="space">Elevated Height</label><br>
											<input type="text" name="woh1" id="woh1" value="" style="font-size:25px;height:40px;width:150px;text-align:center;color:blue" onkeyup="setTimeout(compute2, 100)" onkeypress="setTimeout(compute2, 100)" /><br><br>
