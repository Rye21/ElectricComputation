...
<html lang="ja">
	...
	<head>
		...
		<link rel="icon" href="http://hrdapps33/qcc/img/didyouknow.png" type="image/x-icon" />
		...
		<div class="container-fluid row">
			...
			<nav class="navbar navbar-inverse" style="height:10%;background: rgba(0, 0, 095, 0.6);">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav navbar">
						<div class="navbar-header">
							<a class="navbar-brand" href="index.php"><img src="img/imageedit_24_4871139716.png" style="height:60px;width:120px;margin-top:-10px"></a>
						</div>
						...
						<li class="dropdown">
							  ...
							  <ul class="dropdown-menu">
								...
								<li><a href="http://hrdapps33/qcc/comment_box">Trivia Suggestions</a></li>
								<li><a target="_blank" href="http://hrdapps33/qcc/tcpdf/pattern_exam.php">Create Exam 1</a></li>
								<li><a target="_blank" href="http://hrdapps33/qcc/tcpdf/create_exam.php">Create Exam 2</a></li>
								
							  </ul>
						</li> 
						<li><a href="help.php" style=";margin-top:-3px">Help<span class="glyphicon glyphicon-question-sign"></span></a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<a type="button" class="btn navbar-btn btn-warning btn-md shake-opacity" style="font-family: Georgia;font-weight:bold;float:right;margin-left:250px;margin-top:30px"  id="addtrivia"><i class="glyphicon glyphicon-plus"> ADD TRIVIA</i></a>&nbsp;
					</ul>
				</div>
			</nav>
