...
<html>
	...
	<body>
		...
		<table>
			...
			<form id="myForm2">	
				<tr>
					<td width="50px"  rowspan="2" contenteditable='true' >
					...
					<td style="font-size:20px" width="935px" contenteditable='true'></td>
				...
				<tr>
					...
					<td style="font-size:20px" contenteditable='true'></td>
				</tr>
				<tr>
				...
				<tr>
					<td width="30px"  rowspan="2" contenteditable='true'>
					<label>2.<label>	
					</td>
					<td width="" height="50px" colspan="3">
					<label>Q:<label>
					</td>
					<td  style="font-size:20px"contenteditable='true'></td>
				</tr>
			...
			<br>
			<button  class="btn btn-danger" id="reset" onClick="myFunction()" style="font-size:30px;">Reset</button>								
		</form>	
