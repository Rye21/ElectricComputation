			...
			<nav class="navbar navbar-inverse" style="height:10%;background: rgba(0, 0, 095, 0.6);">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav navbar">
						...
						<!--<li><a href="../index.php">Quiz Trivia</a></li>-->
						...
						<li><a href="../QCC_Quiz.php" style=";margin-top:-4px">Help<span class="glyphicon glyphicon-question-sign"></span></a></li>
			
					</ul>
					<ul class="nav navbar-nav navbar-right">
					<li style='float'><a href="login.php">Admin Home</a></li><li><a href="signout.php">Signout</a></strong></li>
					</ul>
				</div>
			</nav>
