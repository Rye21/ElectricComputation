...
alert('NO NEED TO COMPUTE !! ITS 10kW ( below ) !!');
	...
	<section id="main-content">			
        <section class="wrapper"><br>
			<center><label style="font-size:35px;font-family: arial black">SHUUDENBAN CHECKING</label></center>
						...
						<tbody>
							...
							<div class="col-sm-4">
								...
								<label style="font-size:20px;color:black">Electric Company:</label>	
									...
									<select type="" name="electric_company" id="electric_company"  onchange="kva_check1()" style="font-size:15px;width:200px;text-align:center;color:red;height:35px;font-weight:bold" >
										<option value=""></option>
								...
								<label style="font-size:18px;color:black">KVA</label>
									...
									<label style="font-size:18px;color:red;font-weight:bold">Main Breaker =</label>
							...
							<label style="font-size:25px;color:black;" class="space">Result:</label>									
								<input type="text" id="demo" name="demo"  style="text-align:center;width:530px;font-size:30px;font-weight:bold;border:;background-color:#F0F8FF;" disabled><br>			
								<center class="space"><input class="bg-danger" type="button" onclick="myFunction()" value="Clear Form" style="font-size:15px;color:black;font-weight:bold;float:left;" >									<input type="text" id="demoA" name="demoA" style="width:580px;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;color:blue" disabled></center>
							<hr style="color:gray">
							...
							<label align="center" style="font-size:25px;color:black;" class="space">REMARKS:</label>
								<input align="center" type="text" id="demo2" name="demo2"    style="width:140px;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
							</div>
							<div class="col-sm-4">
							<label align="center" style="font-size:20px;color:black;" class="space">Option Picking:</label>
								<input type="" name="option_p" id="option_p"  style="font-size:20px;width:150px;text-align:center;color:black;color:red;font-weight:bold" readonly="readonly"  />		
