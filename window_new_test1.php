      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
		...
		<body onload="javascript:hideTable()">
			...
			<div id="tab2" class="tab-pane fade in active">
					...
					<center>
						<div class="row">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button style=";border-radius:20%;border-color:gray" type='button' id="show1" name="show1" onClick='javascript:showTable1();' value='show1'><img src="assets/img/low.PNG" id="sample" alt="" style="width:250px;height:250px;border-radius:20%;" /></button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<center><table id="table" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
						<thead>
							<div data-role="header">
						...
						<tbody>
							...
							<!--<tr>
								<td colspan="6" style="border-style:solid"><br>
									<p style="color:blue;font-size:20px;" class="space"><span style="color:red;"> ELEVATED HEIGHT IS LOWER THAN ITEM HEIGHT </span><br><span style="color:red">Formula 1: </span> ((Last 2 digit window serial  <span style="color:red;">x</span>  30.3)  <span style="color:red;">+</span>  Elevated Height) = RESULT <br><span style="color:red;font-size:15px;"> If with Requested Height </span><br><span style="color:red">Formula 2: </span> (( Last 2 Digit Window Serial  <span style="color:red;">x</span>  30.3)  <span style="color:red;">+</span>  Item <span style="color:red;">+</span> Elevated Height <span style="color:red;">+</span> 38 ) = RESULT   </p>	
								</td>									
							</tr>-->
							<tr>
									<?php	
									/* 	include_once 'include/dbcon.php';
										$query="SELECT * FROM computation limit 12";
							...
							foreach( room() as $value ) {
							  $option .= '<option value="'.$value["window_sill"].'">'.$value["window_sill"].'</option>';
							}
							?>
								...
								<td style="vertical-align:middle;width:500px">
									...
									<label style="font-size:18px;color:black" class="space">Item:</label>
										<input style="height:50px;width:40%;font-size:20px;text-align:center;color:blue" class="form-control" id="selectme" name='selectme' value="<?php //echo @$_GET['selectme'];?>" >
										<button type='submit' id="btn" class="btn" class="btn btn-danger"><span class="glyphicon glyphicon-search"></span></button>
									</form>-->
									<br>									
						<form id="myForm1" method="post" enctype="multipart/form-data">		
										
										<input style="height:50px;width:40%;font-size:20px;text-align:center;color:blue" class="form-control" id="selectme" name='selectme' value="<?php echo @$_POST['selectme'];?>" onblur="this.form.submit()" placeholder="Serial">
										<!--<button type='submit' id="btn" class="btn" class="btn btn-danger"><span class="glyphicon glyphicon-search"></span></button>--><br>
										
										<label style="font-size:18px;color:black" class="space">Item:			     </label>
											<select  style="height:50px;width:60%;font-size:20px;text-align:center;color:blue" class="heightitem" id="heightitem"  name="heightitem" onchange="setTimeout(compute1, 10)" onkeypress="setTimeout(compute1, 10)">
												<option><?php echo @$_POST['heightitem']; ?></option>
												<option><?php echo $option; ?></option>
												
											</select>
											<textarea id="heightitemA" name="heightitemA" class="heightitemA hide" style="font-size:1.9em;text-align:center;vertical-align:middle;height:35px;" ></textarea>
											<input type="text" name="heightitemB" id="heightitemB" class="heightitemB hide" />
											<textarea id="st_h" name="st_h" class="st_h hide hide" style="font-size:1.9em;text-align:center;vertical-align:middle;height:35px;" ></textarea>
											<input type="text" name="st_hp" id="st_hp" class="st_hp hide" />
										<br>
										<br>
										<label style="font-size:18px;color:black" class="space">Elevated Height:    </label>
											<input type="number" name="sashheight" id="sashheight" value="" style="height:50px;width:60%;font-size:25px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 10)"/>
										...
										<label style="font-size:18px;color:black" class="space">Requested Height:</label>
											<input type="" name="height1" id="height1" value="" style="height:50px;width:60%;font-size:25px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 10)"  /><br><br>	
										<label style="font-size:18px;color:black">Last 2 Digit of Window Serial:</label>
											<input type="number" name="ws1" id="ws1" value="" style="height:50px;width:42%;font-size:25px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 10)"/>
											<input type="hidden" name="wh1" id="wh1" value="30.3"  />	
										<a href="http://hrdapps33/denkicomputation/window_new_test1.php">
										<input class="bg-danger" type="button" onclick="myFunction1()" value="Clear Form" style="font-size:18px;color:black;font-weight:bold">
										</a>
										<a href="http://hrdapps33/denkicomputation/window_new_test.php">
								...
								<td class="" colspan="5" style="text-align:center;">
									...
									<input type="hidden" name="height" id="height" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
									<input type="text" id="demo1" name="demo1" class="demo1 hide" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
									<input type="text" id="demo12" name="demo12" class="demo12 hide" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
									<input type="text" id="demo13" name="demo13" class="demo13" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
								</td>
						...
						<tr>
								<td colspan="2">
									<iframe style="width:100%;height:500px;overflow:visible" src="
										<?php if(@$_POST["selectme"] == ''){
											echo '';
										} else {
					...
					<form id="myForm2">		
						<center><table id="table2" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
							<thead>
							<div data-role="header">
								<th colspan="6"><h1>Window Computation</h1></th>
							</div>	
								...
								<td style="vertical-align:middle;width:500px">
									<div class="container-fluid">
										...
										<label style="font-size:18px;color:black" class="space">Requested Height:</label>
											...
											<input class="bg-danger" type="button" onclick="myFunction2()" value="Clear Form" style="font-size:18px;color:black;font-weight:bold">
											<input class="bg-success" type="button" value="BACK TO MENU"   onClick="window.location.href=window.location.href" style="font-size:18px;color:black;font-weight:bold">
									</div>	
								</td>
								<td class="" colspan="5" style="text-align:center;">
									<label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
										<input type="hidden" name="height2" id="height2" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
									<input type="text" id="demo2" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" disabled>
								</td>
							</tr>
						</table>
						</center>	
			...
			<form id="myForm3">
						<center><table id="table3" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
							<thead>
								<div data-role="header">
									<th colspan="6"><h1>Window Computation</h1></th>
								</div>	
							...
							?>
								...
								<td class="" colspan="5" style="text-align:center;">
									<label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
										<input type="hidden" name="Total" id="Total" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
									<input type="text" id="demo3" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" disabled>
								</td>
							</tr>
						</table>
						</center>	
					...
					<form id="myForm4">	
						...
						<center><table id="table4" class="table table-condensed" border="2"	 style="background-color:aliceblue;width:80%;border-style:solid">
							<thead>
							<div data-role="header">
								<th colspan="6"><h1>Window Computation</h1></th>
							</div>	
							...
							<tr>
								...
								<td class="" colspan="5" style="text-align:center;">
									<label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
										<input type="" name="height4" id="height4" value="" style="font-size:20px;width:150px;color;text-align:center" class="space" disabled  />
									<input type="text" id="demo4" style="width:400px;height:150px;font-size:45px;font-weight:bold;border:;background-color:#F0F8FF;vertical-align:middle;text-align:center" disabled>
								</td>
							</tr>
						</table>
						</center>
...
<script>
 $(document).ready(function () {
            ...
            $('#heightitem').click(function () {
			  ...
			  var two = $('#heightitem').val();
			 /* if (one == ''){
				 alert ('Please Input Serial First');
				 document.getElementById("heightitem").value =  '';
			 } */
			  if(!$("#selectme").val().match(/^[0-9]{4}$/i)){
			...
			$('#sashheight').click(function () {
              
			  var one = $('#selectme').val();
			  var two = $('#heightitem').val();
			 if (two == ''){
				 alert ('Please Input Item');
				 document.getElementById("sashheight").value =  '';
			 }
