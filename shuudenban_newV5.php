...
alert('NO NEED TO COMPUTE !! ITS 10kW ( below ) !!');
    	...
    	<script>
			...
			function check_powercon() {
				  $("#loaderIcon").show();
				jQuery.ajax({
				url: "check1/check_powerconV5.php",
				data:'code_number='+$("#code_number").val(),
				type: "POST",
				success:function(data){
						...
						<tbody>
							...
							<tr>
								<td style="">
									...
									<div class="col-sm-12" align="center">
												<input class="blink_me" type="text" name="hybrid" id="hybrid"  style="border: none;background:transparent;font-size:40px;width:280px;text-align:center;float:left;margin-top:5px;color:blue;"  readonly />
