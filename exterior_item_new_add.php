		...
		function hitting(){
			...
			//alert(center_tiles);
				...
				function combine(){
					...
					if(exterior_denki_1 != ''){
						if (judge > item3){
							document.getElementById("good_hit").value = '>--- > GOOD !! ITS POSSIBLE < ---<';
							document.getElementById("good_hit").style.color = "green";
						} else {
							document.getElementById("good_hit").value = '>--- > PROHIBITED !! IT WILL HIT < ---<';
							document.getElementById("good_hit").style.color = "maroon";
						}
					} 
				}
				////////////////////minimum/////////////////
			...
			$('#center_tiles1').val(Result4);
				...
				function hitting1_2(){
					var center_tiles = parseFloat($('input[name=std_height1_2]').val()) || 0 ;
				...
				function combine2(){
					...
					if(exterior_denki_1 != ''){
						if (judge > item3){
							document.getElementById("good_hit2").value = '>--- > GOOD !! ITS POSSIBLE < ---<';
							document.getElementById("good_hit2").style.color = "green";
						} else {
							document.getElementById("good_hit2").value = '>--- > PROHIBITED !! IT WILL HIT < ---<';
							document.getElementById("good_hit2").style.color = "maroon";
						}
					}
				}
			...
			function compute3() {
				...
				function combine3(){
					...
					if(exterior_denki_1 != ''){
						if (judge > item3){
							document.getElementById("good_hit3").value = '>--- > GOOD !! ITS POSSIBLE < ---<';
							document.getElementById("good_hit3").style.color = "green";
						} else {
							document.getElementById("good_hit3").value = '>--- > PROHIBITED !! IT WILL HIT < ---<';
							document.getElementById("good_hit3").style.color = "maroon";
						}
					}
				}
				/////////////////////////////
				...
				<input type='button' class="hide" id="hide"  name="hide" onClick='javascript:hideTable();' value='hide'>				
					<table id="table" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm">		
							<tr height="250px">
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black"  onchange="setTimeout(calculate,10)"  id="exterior_denki"  name="exterior_denki"  required="required">
											<option value=""></option>   
									...
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate,10)" id="standard"  name="standard"  required="required">
									...
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>								
										<input type="text" id="R_height" name="R_height"   onkeyup="setTimeout(calculate,10)" onkeypress="setTimeout(calculate,20)"   style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"  ><br><br>				
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										...
										<input type="text" id="std_height" name="std_height" style="width:80px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height" name="top_height"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly>
										<input type="text" id="bottom_height" name="bottom_height"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly>
										<br><br>
							...
							<tr>
								<td colspan="3">
										<input align="center" type="text" id="good_hit" name="good_hit" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
								</td>
							</tr>							
						...
						<form id="myFormS">		
							<tr height="250px">
								...
								<td style="vertical-align:middle;width:500px">
									...
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black"  onchange="setTimeout(calculate_1,10)"   id="exterior_denki_1"  name="exterior_denki_1"  required="required">
											<option value=""></option>   
									...
									<br>
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate_1,10)" id="standard_1"  name="standard_1"  required="required">
											 <option disabled selected>Choose Type</option>
									...
									<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>								
										<input type="text" id="R_height_1" name="R_height_1"   onkeyup="setTimeout(calculate_1,10)" onkeypress="setTimeout(calculate_1,10)"   style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"  >				
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height_1" name="std_height_1" style="width:80px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height_1" name="top_height_1"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly>
										<input type="text" id="bottom_height_1" name="bottom_height_1"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly>
										<br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
										<input type="text" id="minimum_height_1" name="minimum_height_1"  align="center" style="width:200px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
							...
							<td colspan="3">
									...
									<input align="center" type="text" id="demos_1" name="demos_1" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
							</td>
					...
					<table id="table2" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm2">		
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="setTimeout(calculate1, 10)" id="exterior_denki1"  name="exterior_denki1"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<?php	
									...
									<br>
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate1, 10)" id="standard1"  name="standard1"  required="required">
											 <option disabled selected>Choose Type</option>
									...
									<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height1" name="R_height1" onkeyup="setTimeout(calculate1, 10),setTimeout(hitting1,20);" onkeypress="setTimeout(calculate1, 10),setTimeout(hitting1,20);" onchange="setTimeout(calculate1, 10),setTimeout(hitting1,20);" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height1" name="std_height1" style="width:80px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height1" name="top_height1"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly>
										<input type="text" id="bottom_height1" name="bottom_height1"  align="center" style="width:60px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
							...
							<tr>
								<td colspan="3">
										<input align="center" type="text" id="good_hit2" name="good_hit2" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
								</td>
							</tr>	
						...
						<tbody id="items2">
							...
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="setTimeout(calculate1_2, 10)" id="exterior_denki1_2"  name="exterior_denki1_2"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<?php	
									...
									<br>
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate1_2, 10)" id="standard1_2"  name="standard1_2"  required="required">
											 <option disabled selected>Choose Type</option>
									...
									<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height1_2" name="R_height1_2" onkeyup="setTimeout(calculate1_2, 10)" onkeypress="setTimeout(calculate1_2, 10)" onchange="setTimeout(calculate1_2, 10)" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height1_2" name="std_height1_2" style="width:80px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height1_2" name="top_height1_2" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="bottom_height1_2" name="bottom_height1_2" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
										<input type="text" id="minimum_height1_2" name="minimum_height1_2"  align="center" style="width:200px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
							...
							<td colspan="3">
									...
									<input align="center" type="text" id="demos2_2" name="demos2_2" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
							</td>
					...
					<table id="table3" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm3">		
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="setTimeout(calculate2, 10)" id="exterior_denki2"  name="exterior_denki2"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<br>	
									...
									?>	
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate2, 10)" id="standard2"  name="standard2"  required="required">
											 <option disabled selected>Choose Type</option>
										...
										<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height2" name="R_height2" onkeyup="setTimeout(calculate2, 10)" onkeypress="checkemail2A()" onchange="setTimeout(calculate2, 10)" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height2" name="std_height2" style="width:80px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height2_1" name="top_height2_1" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="bottom_height2_1" name="bottom_height2_1" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
							...
							<tr>
								<td colspan="3">
										<input align="center" type="text" id="good_hit3" name="good_hit3" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
								</td>
							</tr>
					...
					<tbody id="items3">
							...
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="setTimeout(calculate2_1, 10)" id="exterior_denki2_3"  name="exterior_denki2_3"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<br>	
									...
									?>	
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="setTimeout(calculate2_1, 10)" id="standard2_3"  name="standard2_3"  required="required" >
											 <option disabled selected>Choose Type</option>
										...
										<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height2_3" name="R_height2_3" onkeyup="setTimeout(calculate2_1, 10)" onkeypress="setTimeout(calculate2_1, 10)" onchange="setTimeout(calculate2_1, 10)" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
										<span class="hidden" id="email2-availability-status"></span>
									<br>
									<br>
									<!--<input class="bg-danger" type="button" onclick="myFunction3()" value="Clear Form" style="font-size:15px;color:black;font-weight:bold">-->	
								...
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height2_3" name="std_height2_3" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="top_height2_3" name="top_height2_3" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<input type="text" id="bottom_height2_3" name="bottom_height2_3" style="width:60px;font-size:25px;color:blue;text-align:center" readonly>
										<br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
										<input type="text" id="minimum_height2_3" name="minimum_height2_3"  align="center" style="width:200px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
							...
							<td colspan="3">
									...
									<input align="center" type="text" id="demos3_3" name="demos3_3" class="blink_me"    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled >
							</td>
						</form>	
						<center><input type="text" class="hide" id="demo2" name="demo2" onClick='javascript:showTable3();' style="font-size:50px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;color:red" disabled></center>					
						</tbody>
