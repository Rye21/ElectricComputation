			...
			<input type='button' class="" id="show" name="show" onClick='javascript:showTable();' value='show'>-->
                        ...
                        <div id="tab2" class="tab-pane fade in active">
                            ...
                            <center>
                                <div class="row">
                                    <div class="column">
                                        <a href="http://hrdapps33/denkicomputation/window_new_case1.php"><button style="border-radius:20%;border-color:gray" type='button' id="show" name="show"><img src="assets/img/high.PNG" id="sample" alt="" style="width:250px;height:250px;border-radius:20%;" /></button></a>
									...
									<p style="color:blue;font-size:20px;" class="space"><span style="color:red;"> ELEVATED HEIGHT IS LOWER THAN ITEM HEIGHT </span><br><span style="color:red">Formula 1: </span> ((Last 2 digit window serial  <span style="color:red;">x</span>  30.3)  <span style="color:red;">+</span>  Elevated Height) = RESULT <br><span style="color:red;font-size:15px;"> If with Requested Height </span><br><span style="color:red">Formula 2: </span> (( Last 2 Digit Window Serial  <span style="color:red;">x</span>  30.3)  <span style="color:red;">+</span>  Item <span style="color:red;">+</span> Elevated Height <span style="color:red;">+</span> 38 ) = RESULT   </p>	
										...
										$result= $db_connect->query($query); */
                                            ...
                                            <td class="" colspan="5" style="text-align:center;">
                                                ...
                                                <input type="text" id="demo13" name="demo13" class="demo13 hide" style="width:400px;height:150px;font-size:45px;font-weight:bold;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align:middle;width:500px">
                                                <div class="container-fluid">
                                                    ...
                                                    <select class="select2_single" style="font-size:25px;text-align:center;height:40px;width:300px;color:blue;margin:auto;" id="window" name="window" required="required" onchange="setTimeout(compute, 10)" onkeypress="setTimeout(compute, 10)" />
                                                    <option value=""></option>
                                                    <option><?php echo $option; ?></option>
                                                    </select>
                                                    ...
                                                    <input type="text" name="ws" id="ws" value="" class="hide" style="height:50px;width:42%;font-size:25px;color:blue;text-align:center" />
                                                    <!--<label style="font-size:18px;color:black">Last 2 Digit of Window Serial:</label>
											...
											<input type="hidden" name="wh" id="wh" value="30.3"  />-->
                                                    ...
                                                    <input class="bg-success" type="button" value="BACK TO MENU" onClick="refreshPage()" style="font-size:18px;color:black;font-weight:bold">
                                                </div>
                                            </td>
                                            <td class="" colspan="5" style="text-align:center;">
                                                <label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
								...
								<td colspan="6" style="border-style:solid"><br>
									<p style="color:blue;font-size:20px;" class="space"><span style="color:red">Formula 1: ELEVATED HEIGHT IS HIGHER THAN ITEM HEIGHT </span><br> Elevated Height  <span style="color:red;">-</span>  38  <span style="color:red;">-</span>  Item Half Size = RESULT  </p>	
                                        ...
                                        <tr>
                                            ...
                                            <td class="" colspan="5" style="text-align:center;">
                                                <label style="font-size:35px;color:red;font-weight:bold;" class="space">Result:</label><br>
                                                <input type="text" name="height4" id="height4" value="" style="font-size:20px;width:150px;text-align:center" class="space hide" disabled />
        ...
        $(function() {
            $(document).on('change', '#window', function() {
                $.ajax({
                    ...
                    document.getElementById("ws").value = document.getElementById("windowValue").value;
