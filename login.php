...
if(@$_REQUEST["username"] && $_REQUEST["password"]){
	...
	//$client = new CouchClient( 'http://fspcad12:5984', 'hrd_masteruser' ); //duplicate couchDB for masterlist
	$query = [
		'$and' => [
			['employee_code' => $_REQUEST["username"]],
	...
	if(count($doc) > 0){
		...
		$_SESSION["full_name"] = $doc[0]->full_name;
...
/* 		$_SESSION["dep_role1"] = $doc[0]->dep_role1;
		$_SESSION["dep_role2"] = $doc[0]->dep_role2; */
		header('Location: ./');
	}else{
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="login.php">
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username" id="username" placeholder="EmployeeCode" autocomplete="off" autofocus>
		            <br>
