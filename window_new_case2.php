...
<script>
    ...
    function compute1() {
        ...
        var height = ((ws1) + sashheight + windowconstant + heightitemB);
        var heightplus = ((ws1) + sashheight + windowconstant + heightitemB);
        var heightminus = ((ws1) + sashheight - windowconstant - heightitemB);
        $('#height').val(height);
        ...
        } else if (height1 != '' && demo13 == result1) {
            document.getElementById("ws1").disabled = true;
        } else if (height1 != '' && demo13 == result) {
        ...
        <section id="main-content">
			...
			<input type='button' class="" id="show" name="show" onClick='javascript:showTable();' value='show'>-->
                        ...
                        <div id="tab2" class="tab-pane fade in active">
                            ...
                            <center>
                                <table id="table" class="table table-condensed" border="2" style="background-color:aliceblue;width:100%;border-style:solid">
                                    <thead>
                                        <div data-role="header">
                                            <th colspan="6">
                                                <h1>Window Computation Case #2</h1>
                                            </th>
                                        </div>
                                    </thead>
                                    <tbody>
										...
										<button type='submit' id="btn" class="btn" class="btn btn-danger"><span class="glyphicon glyphicon-search"></span></button>
                                                    ...
                                                    <form id="myForm1" method="post" enctype="multipart/form-data">
                                                        *<span style="color:red;font-size:15px;">Please Input first 2 or 3 digit window serial</span>
                                                        ...
                                                        <select class="select2_single" style="font-size:25px;text-align:center;height:40px;width:250px;color:blue;margin:auto;" id="window" name="window" required="required" onchange="setTimeout(compute1, 10)" onkeypress="setTimeout(compute1, 10)" />
                                                        <option value=""></option>
                                                        <option><?php echo $option; ?></option>
                                                        </select>
                                                        ...
                                                        <input type="text" name="ws1" id="ws1" value="" class="hide" style="height:50px;width:40%;font-size:25px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 10)" />
                                                        <!--<label style="font-size:18px;color:black">Last 2 Digit of Window Serial:</label>
											<input type="number" name="ws1" id="ws1" value="" style="height:50px;width:40%;font-size:25px;color:blue;text-align:center" onkeyup="setTimeout(compute1, 10)"/>
											<input type="hidden" name="wh1" id="wh1" value="30.3"  />-->
                                                        ...
                                                        <input type="hidden" name="height" id="height" value="" style="font-size:20px;width:150px;text-align:center" class="space" disabled />
                                                        <input type="text" id="demo1" name="demo1" class="demo1 hide" style="width:400px;height:150px;font-size:45px;font-weight:bold;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
                                                        <input type="text" id="demo12" name="demo12" class="demo12 hide" style="width:400px;height:150px;font-size:45px;font-weight:bold;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
                                                        <input type="text" id="demo13" name="demo13" class="demo13" style="width:400px;height:150px;font-size:45px;font-weight:bold;background-color:#F0F8FF;vertical-align:middle;text-align:center" readonly>
                                                        <br>
                                                        <br>
                                                        <a href="http://hrdapps33/denkicomputation/window_new_case2.php">
                                ...
                                <?php
                                if (@$_SESSION["designation"] == 'Team Head' || @$_SESSION["designation"] == 'Team Head Trainee' || @$_SESSION["designation"] == 'Team In-Charge' || @$_SESSION["designation"] == 'Section Head' || @$_SESSION["designation"] == 'Section Head Trainee' || @$_SESSION["designation"] == 'Section In-Charge') {
                                    echo '<a type="button" class="btn navbar-btn btn-info btn-md shake-opacity space" style="font-weight:bold;color:black;font-size:20px;font-family:Century;"  id="addtrivia"><i class="glyphicon glyphicon-send"></i> Send Confirmation</a>';
                                }
                                ?>
                            ...
                            <form id="myForm2">
                                <center>
                                    <table id="table2" class="table table-condensed" border="2" style="background-color:aliceblue;width:80%;border-style:solid">
                                        <thead>
                                            <div data-role="header">
                                                <th colspan="6">
            ...
            <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        ...
                        <h4 style="color:black;">Send Confirmation</h4>
                    </div>
        ...
        $(function() {
            $(document).on('change', '#window', function() {
                $.ajax({
                    ...
                    document.getElementById("ws1").value = document.getElementById("windowValue").value;
