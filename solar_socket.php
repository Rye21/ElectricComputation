        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <div class="tab-content">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <td>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <input type="text" id="demo" name="demo" style="text-align:center;width:300px;font-size:30px;font-weight:bold;background-color:#b6bdc6;" disabled>
					...
					<input type="text" style="width:50px;height:20px;background-color:red;" disabled><span style="color:black;font-size:20px">-CHUBU(�����d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:green;" disabled><span style="color:black;font-size:20px">-TOHOUKU(���k�d��)</span><br>				
					<input type="text" style="width:50px;height:20px;background-color:#3333ff;" disabled><span style="color:black;font-size:20px">-TOKYOU(�����d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:violet;" disabled><span style="color:black;font-size:20px">-HOKURIKU(�k���d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:#009999;" disabled><span style="color:black;font-size:20px">-HOKKAIDOU(�k�C���d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:yellow;" disabled><span style="color:black;font-size:20px">-KANSAI(�֐��d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:brown;" disabled><span style="color:black;font-size:20px">-CHUGOKU(�����d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:pink;" disabled><span style="color:black;font-size:20px">-SHIKOKU(�l���d��)</span><br>
					<input type="text" style="width:50px;height:20px;background-color:#66ffff;" disabled><span style="color:black;font-size:20px">-KYUUSHU(��B�d��)</span><br>
				</div>
				<div class="col-sm-9">
				...
				<p style="color:black;font-size:15px" class="space">    and If the O.P or Option Picking Field is =<span style="color:red"> '�W�d��' </span><img src="assets/img/OP1.PNG" style="height:30px;width:200px;">,its means <span style="color:blue;font-size:25px">WITH SHUUDENBAN</span>.</p>
				<hr>
    ...
    <script>
        ...
        function compute() {
            ...
            if (res == '') {
                ...
                document.getElementById("demo").value = results7;
                document.getElementById("demo").style.color = "red";
            } else if ((electric_company == 'KANSAI(�֐��d��)' || electric_company == 'SHIKOKU(�l���d��)' || electric_company == 'CHUGOKU(�����d��)' || electric_company == 'KYUUSHU(��B�d��)') &&
                ...
                document.getElementById("demo").style.color = "red";
                //////////////////////////////////////////////
            } else if ((electric_company == 'HOKKAIDOU(�k�C���d��)' || electric_company == 'TOHOUKU(���k�d��)' || electric_company == 'TOKYOU(�����d��)' || electric_company == 'HOKURIKU(�k���d��)') &&
                (powercon_1 == '5.5kW' && powercon_2 == '5.5kW' || powercon_1 == '5.5kW' && powercon_2 == '8.0kW' || powercon_1 == '5.5kW' && powercon_2 == '9.9kW' || powercon_1 == '8.0kW' && powercon_2 == '8.0kW') && contract_kind != 1) {
                ...
                document.getElementById("demoA").value = resulta;
                document.getElementById("demo").style.color = "red";
            } else if (electric_company == 'CHUBU(�����d��)' && res2 > res4 && contract_kind != 1) {
                ...
                document.getElementById("demoA").value = resultb;
                document.getElementById("demo").style.color = "red";
            } else if (electric_company == 'CHUBU(�����d��)' && res4 == res2 && (powercon_1 == '8.0kW' || powercon_1 == '9.9kW') && powercon_2 != '8.0kW') {

                document.getElementById("demo").value = results1;
                document.getElementById("demoA").value = resultb;
                document.getElementById("demo").style.color = "red";
            } else if (electric_company == 'CHUBU(�����d��)' && res4 == res2) {

                document.getElementById("demo").value = results;
                document.getElementById("demoA").value = resulta;
                document.getElementById("demo").style.color = "green";
            } else if (electric_company == 'CHUBU(�����d��)' && res2 < res4) {
                ...
                document.getElementById("demoA").value = resultb;
                document.getElementById("demo").style.color = "red";
            } else if (KVA == '' && electric_company == 'CHUBU(�����d��)' && powercon_1 == '5.5kW' && powercon_2 == '5.5kW' || powercon_1 == '5.5kW' && powercon_2 == '8.0kW' || powercon_1 == '5.5kW' && powercon_2 == '9.9kW' || powercon_1 == '8.0kW' && powercon_2 == '8.0kW') {
