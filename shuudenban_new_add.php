    	...
    	<script>
			...
			////////////////solar//////////////////////////////////
			 function check_OptionPicking2() {
				...
				} else if (powv4 == 1 && hybrid == 1){
					//setTimeout(check_hybrid(),600);
				} else {
					var op1 = document.getElementById("demosolar").value = 'NOT TALLY';
					document.getElementById("demosolar").style.color = "maroon";
				}
			...
			/////////////////////check_PlanNumber///////////////////
				...
				success:function(data){
				$("#email6-availability-status").html(data);
				var C = document.getElementById("hybrid").value = document.getElementById("email6-availability-status").innerHTML;
				var D = document.getElementById("hybrid").value;
				if (D == 1){
					alert('Hybrid !! Not Applicable in this computation');
				}
							...
							<div class="row">
								...
								<div class="col-sm-4">	
									...
									<label style="font-size:20px;color:black" class="space">Plan Number:     </label>		
										<input type="text" name="plan_number" id="plan_number"   style="font-size:20px;width:150px;text-align:center;color:red"  readonly="readonly"  />
										<input type="text" name="hybrid" id="hybrid"   		 style="font-size:20px;width:150px;text-align:center;color:red"  	 readonly="readonly"  class="hide" />
