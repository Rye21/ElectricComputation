							...
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;background-color:">
									<label style="font-size:18px;color:black"class="space">Ceiling Height:</label><br><br>
										<select  style="height:40px;font-size:25px;text-align:center;width:150px;color:blue" id="CH7"  name="CH7" class="CH7"required="required"  onchange="setTimeout(compute1, 100)"  >
											<option value=""></option>
									...
									<label style="font-size:18px;color:black" class="space">			Elevated Height</label><br>	
										<select   style="font-size:25px;text-align:center;height:40px;width:300px;color:blue;margin:auto;" id="wdh"  name="wdh" required="required" onchange="setTimeout(compute1, 100)"  onkeypress="setTimeout(compute1, 100)" />
											<option value=""></option>
					...
					<table class="table table-condensed" border="2"	 style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;background-color:">
									<label style="font-size:18px;color:black"class="space">Ceiling Height:</label><br><br>
										<select style="font-size:25px;text-align:center;height:40px;width:150px;color:blue" id="CH1"  name="CH1" required="required" onchange="setTimeout(compute2, 100)"  > 
											<option value=""></option>
											<option value="2400">2400</option>
											<option value="2200">2200</option>
											<option value="2300">2300</option>
							...
							?>		
									...
									<label style="font-size:18px;color:black" class="space">	Window/Door Serial</label>
									<label style="font-size:18px;color:black" class="space">		    Elevated Height</label><br>										
										<select   style="font-size:25px;text-align:center;height:40px;width:300px;color:blue" id="wdh1"  name="wdh1" required="required" onchange="setTimeout(compute2, 100)"  onkeypress="setTimeout(compute2, 100)" />
											<option value=""></option>
