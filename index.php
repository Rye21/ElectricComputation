...
if(!empty($_SERVER["HTTP_CLIENT_IP"])){
		...
		if(preg_match('/^10.169.33.214$/',$ip)){
			$rights = true;
		}else{
			$rights = false;
		}
				  ...
				  <?php 
					...
					while($row = mysqli_fetch_array($result)){
						...
						echo '<tr>';
								...
								echo '<td style="font-size:20px;text-align:center;width:1000px;">'.$category.'</td>';
								echo '<td style="font-size:20px;text-align:center;width:100px;">'.$visits.'</td>';
						echo '</tr>';	
  ...
  if (event.target == modal) {
          ...
          <div id="sidebar"  class="nav-collapse">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
				   ...
				   <li class="sub-menu">
                      <a href="height_match.php" >
                          <!--<i class="fa fa-dashboard"></i>-->
                          <span>HEIGHT MATCH</span>
                      </a>
                  </li>
				  <li class="sub-menu">
                      <a href="kansen_size.php" >
                          <!--<i class="fa fa-dashboard"></i>-->
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            text: 'When in doubt? Check it out !! " When Quality Is In Our Mind, Mistakes Will Stay Behind"',
