...
alert('NO NEED TO COMPUTE !! ITS 10kW ( below ) !!');
		...
		/////////////////////bundenban///////////////////
				...
				//console.log(z);
				if (nisetai == '✘' && spowers == '✘'){
						document.getElementById('imageDiv').innerHTML = '<img src="bundenban_image/J_bundenban.PNG" />';
				...
				if (a == '分電盤-5(nisetai)' && c == '分電盤-6(nisetai)'){
						document.getElementById('imageDiv').innerHTML = '<img src="bundenban_image/1_nisetai.PNG" />';
						document.getElementById('imageDiv2').innerHTML = '<img src="bundenban_image/2_nisetai.PNG" />';
						document.getElementById("b_result").value = 'NO PROBLEM';
						document.getElementById("b_result").style.color = "blue";
				...
				if (a == '分電盤' && c == '分電盤-3'){
						document.getElementById('imageDiv').innerHTML = '<img src="bundenban_image/J_bundenban.PNG" />';
						document.getElementById('imageDiv2').innerHTML = '<img src="bundenban_image/Z_bundenban.PNG" />';
						document.getElementById("b_result").value = 'NO PROBLEM';
						document.getElementById("b_result").style.color = "blue";
				}
				if (a == '分電盤-3' && c == '分電盤-5(nisetai)' && e == '分電盤-6(nisetai)'){
						document.getElementById('imageDiv').innerHTML = '<img src="bundenban_image/Z_bundenban.PNG" />';
						document.getElementById('imageDiv2').innerHTML = '<img src="bundenban_image/1_nisetai.PNG" />';
						document.getElementById('imageDiv3').innerHTML = '<img src="bundenban_image/2_nisetai.PNG" />';
						document.getElementById("b_result").value = 'NO PROBLEM';
						document.getElementById("b_result").style.color = "blue";
				} 
				if (a == '分電盤-5(nisetai)' && c == '分電盤-6(nisetai)' && e == '分電盤-7(nisetai)'){
						document.getElementById('imageDiv').innerHTML = '<img src="bundenban_image/1_nisetai.PNG" />';
						document.getElementById('imageDiv2').innerHTML = '<img src="bundenban_image/2_nisetai.PNG" />';
						document.getElementById('imageDiv3').innerHTML = '<img src="bundenban_image/3_nisetai.PNG" />';
						document.getElementById("b_result").value = 'NO PROBLEM';
						document.getElementById("b_result").style.color = "blue";
				}
				if (nisetai == '✘' && a == '分電盤-5(nisetai)' && c == '分電盤-6(nisetai)'){
						document.getElementById("b_result").value = 'PROBLEM';
						document.getElementById("b_result").style.color = "red";
				}
					...
					<table class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<tbody>
							...
							<div class="container-fluid">
								...
								<div class="col-sm-4">
									<input type="text" name="b1" id="b1"  style="font-size:30px;width:250px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />
									<input type="text" name="c1" id="c1"  style="font-size:30px;width:100px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />
									<br>
									<br>
									<input type="text" name="b2" id="b2"  style="font-size:30px;width:250px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />
									<input type="text" name="c2" id="c2"  style="font-size:30px;width:100px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />
									<br>
									<br>
									<input type="text" name="b3" id="b3"  style="font-size:30px;width:250px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />
									<input type="text" name="c3" id="c3"  style="font-size:30px;width:100px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;"   readonly="readonly" />		
								</div>
								<div class="col-sm-2">
									<div id="imageDiv"></div><br>	
									<div id="imageDiv2"></div><br>	
								...
								<div class="col-sm-2" style="margin-left:-60px;">	
											<!--<input class="bg-danger" type="button" onclick="myFunction()" value="Clear Form" style="font-size:25px;color:black;font-weight:bold;float:left;" >-->
											<label style="font-size:45px;color:red;" class="space">Result:</label>									
											<input type="text" id="b_result" name="b_result"  style="text-align:center;width:250px;font-size:30px;font-weight:bold;border:;background-color:#b6bdc6;" disabled>
								</div>
							<!--<div class="col-sm-4">		
							<img src="http://hrdapps33/denkicomputation/bundenban_image/J_bundenban.PNG">
											<label style="font-size:18px;color:black"><img src="http://hrdapps33/denkicomputation/denkilogo/x1.PNG">=</label>
												<input type="text" name="option_p1" id="option_p1"  style="font-size:30px;width:150px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;" readonly="readonly"  />	
											<label style="font-size:18px;color:black"><img src="http://hrdapps33/denkicomputation/denkilogo/x2.PNG">=</label>
												<input type="text" name="option_p2" id="option_p2"  style="font-size:30px;width:150px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;" readonly="readonly"  />
