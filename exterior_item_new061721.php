<?php
    ...
    $sql = "UPDATE views SET visits = visits+1 WHERE id = 8";
    $conn->query($sql);
...
alert('NO NEED TO COMPUTE !! ITS 10kW ( below ) !!');
		...
		function computeGS() {
			...
			/* if (exterior_denkiGS == 'meterbox1' && (ecompany == 'HOKKAIDOU(北海道電力)' || ecompany == 'TOHOUKU(東北電力)' || ecompany == 'CHUBU(中部電力)')){
				$("#exterior_denkiGS").val(exterior_denkiGS);
				
			} else if (exterior_denkiGS == 'meterbox2' && (ecompany == 'HOKKAIDOU(北海道電力)' || ecompany == 'TOHOUKU(東北電力)' || ecompany == 'CHUBU(中部電力)')){
				alert('not possible');
				$("#exterior_denkiGS").val("");
	...
	$(document).ready(function() {
		...
		function check_PlanNumber() {
				...
				//alert(number6);
					...
					} else if (number4 != '' && (number6 == '２４０+□Ｆ' || number6 == '２４０+ＴＦ' || number6 == '２４０＋Ｆ') && number5 == '140 dodai' && number8 == '浮上タイプ'   ){
						document.getElementById("show1").click();
				  ...
				  <li class="sub-menu">
					  ...
					  <ul class="sub">
							<!--<li class="active"><a href="exterior_item_new_back.php">EXTERIOR ITEMS CENTERING OF TILE<span style="color:red;">( Single Item )</span></a></li>-->
                         	<li ><a data-toggle="tab" href="https://www.w3schools.com/bootstrap/tryit.asp?filename=trybs_theme_band_complete&amp;stacked=h#tab1">EXTERIOR ITEMS CENTERING OF TILE <!--with <span style="color:orange;">( Two Items )--></a></li>           	
                      </ul>
                  </li>
				  <li class="sub-menu">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
			<center><label class="head">EXTERIOR ITEM HEIGHT <!--<span style="color:orange;">( HITTING ITEMS )</span>--> COMPUTATION</label></center>
				...
				<input type='button' class="hide" id="hide"  name="hide"  onClick='javascript:hideTable();' value='hide'>				
					<table id="table" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm">		
							<tr height="250px">
								...
								<span>	
									<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										<textarea type="text" value="" name="meterbox240" id="meterbox240" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>									
								...
								<span>
									<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
											...
											<input type="text" id="plus240" name="plus240"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			  
						...
						<form id="myFormS">		
							<tr height="250px">
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									<textarea type="text" value="" name="meterbox2402" id="meterbox2402" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">GL to FL height for meter </b>
										<input type="text" id="plus2402" name="plus2402"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			  
					...
					<table id="table2" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm2">		
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									<textarea type="text" value="" name="meterbox240t" id="meterbox240t" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">GL to FL height for meter </b>
										<input type="text" id="plus240T" name="plus240T"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			  
						...
						<tbody id="items2">
							...
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									<textarea type="text" value="" name="meterbox240t2" id="meterbox240t2" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">GL to FL height for meter </b>
										<input type="text" id="plus240T2" name="plus240T2"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			  
					...
					<table id="table3" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm3">		
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									<textarea type="text" value="" name="meterbox260" id="meterbox260" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">GL to FL height for meter </b>
										<input type="text" id="plus260" name="plus260"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			
					...
					<tbody id="items3">
							...
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;"> 
									<textarea type="text" value="" name="meterbox2602" id="meterbox2602" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">GL to FL height for meter </b>
										<input type="text" id="plus2602" name="plus2602"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			
					...
					<table id="tableGS" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						<thead>
							<div data-role="header" class="" id="">
								<th colspan="6"><h1>240/265 GrandSaison</h1></th>				
							</div>
						</thead>
						<tbody >
							<tr >	
						...
						<form id="myForm">		
							<tr height="250px">
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									...
									<span>
									<!--<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;-->
										<select  style="height:50px;width:100%;font-size:25px;text-align:center;color:black"  onchange="setTimeout(calculateGS,10)"  id="exterior_denkiGS"  name="exterior_denkiGS"  required="required">
											<option value=""></option>   
											<option><?php echo $option; ?></option>	
										</select>
												<?php
										...
										<br>
									<!--<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;-->
										<select  style="height:50px;width:100%;font-size:25px;text-align:center" onchange="setTimeout(calculateGS,10)" id="standardGS"  name="standardGS"  required="required">
											 <option disabled selected>Choose Type</option>
								...
								<span>	
									<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										<textarea type="text" value="" name="meterboxGS" id="meterboxGS" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
										<input align="center" type="text" id="notfollowGS" name="notfollowGS" class=""    style="color:red;width:70%;font-size:20px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center" disabled ><br>										  					 											
								...
								<span>
									<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
											...
											<b style="font-size:20px" class="space">Standard height  </b>																	
											<input type="text" id="std_heightGS" name="std_heightGS" style="width:200px;font-size:25px;color:blue;text-align:center" readonly>
											<br><br>
											<b style="font-size:20px" class="space">Minimum height </b>
											<input type="text" id="minimum_heightGS" name="minimum_heightGS"  align="center" style="width:200px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
											...
											<b style="font-size:20px" class="space">GL to FL height for meter</b>
											<input type="text" id="plusMeterboxGS" name="plusMeterboxGS"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>			  
											...
											<b style="font-size:20px" class="space">Low Nokiten	  </b>
											<input type="text" id="low_nokitenGS" name="low_nokitenGS" align="center" style="width:200px;font-size:25px;color:blue;text-align:center" readonly><br><br>
											...
											<b style="font-size:20px" class="space">High Nokiten        </b>
											<input type="text" id="high_nokitenGS" name="high_nokitenGS" align="center" style="width:200px;font-size:25px;color:blue;text-align:center" readonly><br><br>
						...
						<tbody id="itemsGS">
							<tr >
								<td colspan="3" style="height:10px;">
										...
										<input align="center" type="text" id="good_hitGS" name="good_hitGS" class=""    style="color:red;width:100%;font-size:30px;font-weight:bold;border:none;text-align:center;background-coor:none;" disabled >							
								</td>
							</tr>
							<tr style="border-top:2pt solid black;">	
							...
							<tr height="250px">
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
									...
									<div class="col-sm-6" style="margin-left:50px;">
										<span>
										<!--<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;-->
										<select  style="height:50px;width:100%;font-size:25px;text-align:center;color:black"  onchange="setTimeout(calculate_1GS,10)"   id="exterior_denki_1GS"  name="exterior_denki_1GS"  required="required">
											<option value=""></option>   
											<option><?php echo $option1; ?></option>	
										</select>
										<?php	
									...
									<br>
										<!--<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;-->
										<select  style="height:50px;width:100%;font-size:25px;text-align:center" onchange="setTimeout(calculate_1GS,10)" id="standard_1GS"  name="standard_1GS"  required="required">
											 <option disabled selected>Choose Type</option>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">	
									<textarea type="text" value="" name="meterboxGS2" id="meterboxGS2" style="resize: none;color:#d72be3;width:90%;font-size:25px;font-weight:bold;border:none;background-color:#F0F8FF;text-align:center;" disabled></textarea><br>
								...
								<td style="text-align:center;vertical-align:middle;width:500px;max-height: 150px;overflow: hidden;">
										...
										<b style="font-size:20px" class="space">Standard height  </b>									
										<input type="text" id="std_height_1GS" name="std_height_1GS" style="width:200px;font-size:25px;color:blue;text-align:center" readonly>
										<br><br>
										<b style="font-size:20px" class="space">Minimum height </b>
										<input type="text" id="minimum_height_1GS" name="minimum_height_1GS"  align="center" style="width:200px;font-size:25px;color:blue;text-align:center"  readonly><br><br>
										...
										<b style="font-size:20px" class="space">GL to FL height for meter</b>
											<input type="text" id="plusMeterboxGS2" name="plusMeterboxGS2"  align="center" style="width:200px;font-size:25px;color:#d72be3;text-align:center"  readonly>				  
										...
										<b style="font-size:20px" class="space">Low Nokiten	  </b>
										<input type="text" id="low_nokiten_1GS" name="low_nokiten_1GS" align="center" style="width:200px;font-size:25px;color:blue;text-align:center" readonly><br><br>
										...
										<b style="font-size:20px" class="space">High Nokiten        </b>
										<input type="text" id="high_nokiten_1GS" name="high_nokiten_1GS" align="center" style="width:200px;font-size:25px;color:blue;text-align:center" readonly><br><br>
