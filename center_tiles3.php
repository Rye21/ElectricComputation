				...
				if (R_height > std_height){
					...
					//if(standard == 'EWH_2f' || standard == 'EWL_2f' || standard == 'EWH_3f' || standard == 'EWL_3f'  && Result5 > std_height){
					 if((exterior_denki == 'Wall Mounted Light' && standard == 'EWH_2f') || (exterior_denki == 'Wall Mounted Light' && standard == 'EWL_2f') || (exterior_denki == 'Wall Mounted Light' && standard == 'EWH_3f') || (exterior_denki == 'Wall Mounted Light' && standard == 'EWL_3f') || 
						(exterior_denki == 'bousui switch' && standard == 'EWH_2f') || (exterior_denki == 'bousui switch' && standard == 'EWL_2f') || (exterior_denki == 'bousui switch' && standard == 'EWH_3f') || (exterior_denki == 'bousui switch' && standard == 'EWL_3f') || 	
						(exterior_denki == 'sensor switch' && standard == 'EWH_2f') || (exterior_denki == 'sensor switch' && standard == 'EWL_2f') || (exterior_denki == 'sensor switch' && standard == 'EWH_3f') || (exterior_denki == 'sensor switch' && standard == 'EWL_3f') ||  	
						(exterior_denki == 'bousui socket' && standard == 'EWH_2f') || (exterior_denki == 'bousui socket' && standard == 'EWL_2f') || (exterior_denki == 'bousui socket' && standard == 'EWH_3f') || (exterior_denki == 'bousui socket' && standard == 'EWL_3f') || 	
						(exterior_denki == 'joint box' && standard == 'EWH_2f') || (exterior_denki == 'joint box' && standard == 'EWL_2f') || (exterior_denki == 'joint box' && standard == 'EWH_3f') || (exterior_denki == 'joint box' && standard == 'EWL_3f') 	
						&& Result5 > std_height){
							alert(judge);
						}  else if (  std_height1 == ''  ){
							//alert('NOT');
				...
				$('#center_tiles1').val(Result5);
					...
					if (R_height1 > std_height1){
						...
						if(( exterior_denki1 == 'Wall Mounted Light' 	&& standard1 == 'EWH_2f') || (exterior_denki1 == 'Wall Mounted Light' 	&& standard1 == 'EWL_2f') || (exterior_denki1 == 'Wall Mounted Light'	&& standard1 == 'EWH_3f') || (exterior_denki1 == 'Wall Mounted Light' 	&& standard1 == 'EWL_3f') || 
							(exterior_denki1 == 'bousui switch' 		&& standard1 == 'EWH_2f') || (exterior_denki1 == 'bousui switch' 		&& standard1 == 'EWL_2f') || (exterior_denki1 == 'bousui switch' 		&& standard1 == 'EWH_3f') || (exterior_denki1 == 'bousui switch' 		&& standard1 == 'EWL_3f') || 	
							(exterior_denki1 == 'sensor switch' 		&& standard1 == 'EWH_2f') || (exterior_denki1 == 'sensor switch' 		&& standard1 == 'EWL_2f') || (exterior_denki1 == 'sensor switch' 		&& standard1 == 'EWH_3f') || (exterior_denki1 == 'sensor switch' 		&& standard1 == 'EWL_3f') ||  	
							(exterior_denki1 == 'bousui socket' 		&& standard1 == 'EWH_2f') || (exterior_denki1 == 'bousui socket' 		&& standard1 == 'EWL_2f') || (exterior_denki1 == 'bousui socket' 		&& standard1 == 'EWH_3f') || (exterior_denki1 == 'bousui socket' 		&& standard1 == 'EWL_3f') || 	
							(exterior_denki1 == 'joint box' 			&& standard1 == 'EWH_2f') || (exterior_denki1 == 'joint box' 			&& standard1 == 'EWL_2f') || (exterior_denki1 == 'joint box' 			&& standard1 == 'EWH_3f') || (exterior_denki1 == 'joint box' 			&& standard1 == 'EWL_3f') 	
							&& Result5 > std_height4){
								alert(judge);
							}  else if (  std_height4 == ''  ){
								//alert('NOT');
				...
				$('#center_tiles2').val(Result5);
					...
					if (R_height2 > std_height2){
						...
						if(( exterior_denki2 == 'Wall Mounted Light' 	&& standard2 == 'EWH_2f') || (exterior_denki2 == 'Wall Mounted Light' 	&& standard2 == 'EWL_2f') || (exterior_denki2 == 'Wall Mounted Light'	&& standard2 == 'EWH_3f') || (exterior_denki2 == 'Wall Mounted Light' 	&& standard2 == 'EWL_3f') || 
							(exterior_denki2 == 'bousui switch' 		&& standard2 == 'EWH_2f') || (exterior_denki2 == 'bousui switch' 		&& standard2 == 'EWL_2f') || (exterior_denki2 == 'bousui switch' 		&& standard2 == 'EWH_3f') || (exterior_denki2 == 'bousui switch' 		&& standard2 == 'EWL_3f') || 	
							(exterior_denki2 == 'sensor switch' 		&& standard2 == 'EWH_2f') || (exterior_denki2 == 'sensor switch' 		&& standard2 == 'EWL_2f') || (exterior_denki2 == 'sensor switch' 		&& standard2 == 'EWH_3f') || (exterior_denki2 == 'sensor switch' 		&& standard2 == 'EWL_3f') ||  	
							(exterior_denki2 == 'bousui socket' 		&& standard2 == 'EWH_2f') || (exterior_denki2 == 'bousui socket' 		&& standard2 == 'EWL_2f') || (exterior_denki2 == 'bousui socket' 		&& standard2 == 'EWH_3f') || (exterior_denki2 == 'bousui socket' 		&& standard2 == 'EWL_3f') || 	
							(exterior_denki2 == 'joint box' 			&& standard2 == 'EWH_2f') || (exterior_denki2 == 'joint box' 			&& standard2 == 'EWL_2f') || (exterior_denki2 == 'joint box' 			&& standard2 == 'EWH_3f') || (exterior_denki2 == 'joint box' 			&& standard2 == 'EWL_3f') 	
							&& Result5 > std_height3){
								alert(judge);
							}  else if (  std_height3 == ''  ){
								//alert('NOT');
...
document.getElementById('demo2').style.display = "none"; 
	...
	<section id="main-content">			
        <section class="wrapper"><br>
			<center><label style="font-size:35px;font-family: arial black">EXTERIOR ITEM HEIGHT COMPUTATION</label></center>
							...
							<tr height="250px">
								...
								<td style="vertical-align:middle;width:500px">
									...
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black"  onchange="checkemailAvailability(),checkemailA(),setTimeout(compute, 500)" onblur="checkemailAvailability(),checkemailA(),setTimeout(compute, 500)"  id="exterior_denki"  name="exterior_denki"  required="required">
											<option value=""></option>   
						...
						<form id="myForm2">		
							<tr>
								...
								<td style="text-align:center;vertical-align:middle;background-color:">										  					 											
									...
									<label style="font-size:25px;color:black;color:red" class="space">Item Height to Use</label>																	
									<!--<span style="font-size:11px;color:blue;float:left">*Check if exceeding to <span style="color:red;font-weight:bold">LOW NOKITEN & HIGH NOKITEN</span> height.</span><br>	
									<span style="font-size:11px;color:blue;float:left">*If exceeds check location of item if with  <span style="color:red;font-weight:bold">LOAD</span> above the item.</span><br>	
									<span style="font-size:11px;color:blue;float:left">*Height should not be lower than <span style="color:red;font-weight:bold">MINIMUM HEIGHT</span>.</span>-->
								</td>
