...
<head>
    ...
    <script>
        ...
        function check_powercon() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_powerconV5.php",
                data: 'code_number=' + $("#code_number").val() +
                    '&plan_number=' + $("#plan_number").val(),
                type: "POST",
                success: function(data) {
                    ...
                    var pow3 = number7.substr(2, 1);
                    var pow4 = number7.substr(3, 1);
                    var pow5 = number7.substr(4, 1);
                    ...
                    var powv4 = document.getElementById("Inverter40Qty").value = pow4;
                    var powv5 = document.getElementById("Inverter59Qty").value = pow5;
                    var hybrid = document.getElementById("hybrid").value;
                    //alert(powv5);
                    if (powv1 == 2 && powv2 == 0 && powv3 == 0 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '5.5kW';
                        document.getElementById("powercon_2").value = '5.5kW';
                    } else if (powv1 == 0 && powv2 == 2 && powv3 == 0 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '8.0kW';
                        document.getElementById("powercon_2").value = '8.0kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 2 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '9.9kW';
                        document.getElementById("powercon_2").value = '9.9kW';
                    } else if (powv1 == 1 && powv2 == 1 && powv3 == 0 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '5.5kW';
                        document.getElementById("powercon_2").value = '8.0kW';
                    } else if (powv1 == 0 && powv2 == 1 && powv3 == 1 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '8.0kW';
                        document.getElementById("powercon_2").value = '9.9kW';
                    } else if (powv1 == 1 && powv2 == 0 && powv3 == 1 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_1").value = '5.5kW';
                        document.getElementById("powercon_2").value = '9.9kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 1 && powv5 == 0) {
                        document.getElementById("powercon_3").value = '4.0kW';
                        //document.getElementById("powercon_2").value = '9.9kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 1 && powv5 == 1) {
                        document.getElementById("powercon_3").value = '4.0kW';
                        document.getElementById("powercon_4").value = '5.9kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 0 && powv5 == 2) {
                        document.getElementById("powercon_3").value = '5.9kW';
                        document.getElementById("powercon_4").value = '5.9kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 1 && powv4 == 0 && powv5 == 0) {
                        document.getElementById("powercon_5").value = '9.9kW';
                        //document.getElementById("powercon_4").value = '5.9kW';
                    } else if (powv1 == 0 && powv2 == 0 && powv3 == 1 && powv4 == 0 && powv5 == 1) {
                        document.getElementById("powercon_4").value = '5.9kW';
                        document.getElementById("powercon_5").value = '9.9kW';
                        //document.getElementById("powercon_4").value = '5.9kW';
                    } else {
                    ...
                    if (hybrid == 'HYBRID POWER' && powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 1 && powv5 == 1) {
                        document.getElementById("powerqty").value = '2';
                        document.getElementById("powercon_1").value = '';
                        document.getElementById("powercon_2").value = '';
                    } else if (hybrid == 'HYBRID POWER' && powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 0 && powv5 == 2) {
                        document.getElementById("powerqty").value = '2';
                        document.getElementById("powercon_1").value = '';
                        document.getElementById("powercon_2").value = '';
                    } else if (hybrid == 'HYBRID POWER' && powv1 == 0 && powv2 == 0 && powv3 == 1 && powv4 == 0 && powv5 == 1) {
                        document.getElementById("powerqty").value = '2';
                        document.getElementById("powercon_1").value = '';
                        document.getElementById("powercon_2").value = '';
                    } else if (hybrid == 'HYBRID POWER' && powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 0 && powv5 == 1) {
                        document.getElementById("powerqty").value = '1';
                        document.getElementById("powercon_1").value = '';
                        document.getElementById("powercon_2").value = '';
                    } else if (hybrid == 'HYBRID POWER' && powv1 == 0 && powv2 == 0 && powv3 == 0 && powv4 == 0 && powv5 == 3) {
                        document.getElementById("powerqty").value = '2';
                        document.getElementById("powercon_1").value = '';
                        document.getElementById("powercon_2").value = '';
                    }
        ...
        function hybrid() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_hybrid.php",
                data: 'code_number=' + $("#code_number").val() +
                    '&plan_number=' + $("#plan_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email6-availability-status").html(data);
                    var number1 = document.getElementById("hybrid").value = document.getElementById("email6-availability-status").innerHTML;
        ...
        function check_OptionPicking() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_OptionPicking.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email5-availability-status").html(data);
        ...
        function check_OptionPicking2() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_OptionPicking_solar.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email5-availability-status").html(data);
            ...
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_OptionPicking_solar2.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email5-availability-status").html(data);
            ...
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_OptionPicking_solar3.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email5-availability-status").html(data);
					...
					document.getElementById("demosolar").style.color = "blue";
                        ...
                        var op1 = document.getElementById("demosolar").value = 'OK(✔)';
                        document.getElementById("demosolar").style.color = "blue";
                    } else if (hybrid == 'HYBRID POWER' && powv4 == 2 && op1 == 1) {
                        var op1 = document.getElementById("demosolar").value = 'OK(✔)';
                        document.getElementById("demosolar").style.color = "blue";
                    } else if (hybrid == 'HYBRID POWER' && (powv4 == '1' && op1 == '' || powv4 == 1 && op2 == '' || powv4 == 1 && op3 == '')) {
                        var op1 = document.getElementById("demosolar").value = 'OK(✔)';
                        document.getElementById("demosolar").style.color = "blue";
                    } else if (powv4 == '') {
        ...
        function bundenban() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_bundenban.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email6-availability-status").html(data);
            ...
            jQuery.ajax({
                url: "check2/check_solarpower.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email6-availability-status").html(data);
        ...
        function bundenban_picking() {
            $("#loaderIcon").show();
            jQuery.ajax({
                url: "check2/check_bundenban_picking.php",
                data: 'code_number=' + $("#code_number").val(),
                type: "POST",
                success: function(data) {
                    $("#email6-availability-status").html(data);
        ...
        <section id="main-content">
            <div class="sticky">
                <td style="text-align:center;vertical-align:middle;">
                    <p style="color:white">* Press<span style="color:red;font-weight:bold"> ENTER </span>after you put the Customer Code *</p>
                    <label style="font-size:20px;color:#ffff33;font-style:italic;">Customer Code:</label>
                    <input type="text" name="code_number" id="code_number" style="font-size:20px;width:170px;text-align:center;color:red;background: rgba(0,0,0,.5)" maxlength="12" />
                    <label style="font-size:20px;color:#ffff33;font-style:italic;">Plan Number: </label>
                    <select type="text" name="plan_number" id="plan_number" onblur="setTimeout(kva_check1, 10)" onchange="setTimeout(kva_check1, 10)" onselect="setTimeout(kva_check1, 20)" style="font-size:20px;width:170px;text-align:center;color:red;background: rgba(0,0,0,.5)" />
                    <option name="plan_number"></option>
                    </select>
                    <input class="bg-danger" type="button" onclick="window.location.href=window.location.href" value="Clear Form" style="font-size:25px;color:black;font-weight:bold;"><br>
                    <span> <span class="blink_me" style="color:white;font-size:15px;font-weight:bold">*Select/Check Plan number if Latest/Not Tally</span></span><br>
                    <p style="font-size:25px;color:red;" id="hy"></p>
            ...
            <section class="wrapper">
                <div class="tab-content">
                        ...
                        <form id="myForm">
							...
							<div class="col-sm-6">	
									...
									<label style="font-size:20px;color:black">Customer Code:</label>
										<input type="text" name="code_number" id="code_number" style="font-size:20px;width:150px;text-align:center;color:red;" maxlength="12"   />
									...
									<label style="font-size:20px;color:black" class="space">Plan Number:     </label>		
										<select type="text" name="plan_number" id="plan_number"  onblur="setTimeout(kva_check1, 10)" onchange="setTimeout(kva_check1, 10)" onselect="setTimeout(kva_check1, 20)"  style="font-size:20px;width:150px;text-align:center;color:red"   />
											<option name="plan_number"></option>
										</select>
										
										
										<span> <span class="blink_me" style="color:red;font-size:15px;font-weight:bold">*Select/Check Plan number if Latest/Not Tally</span></span><br>
										<p style="font-size:25px;color:red;"id="hy"></p>
							</div>	
                                        ...
                                        <tr>
                                            <td>
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="demo" name="demo" style="text-align:center;width:530px;font-size:30px;font-weight:bold;background-color:#b6bdc6;" disabled>
                                                ...
                                                <div class="col-sm-6" align="center">
                                                    ...
                                                    <input type="text" id="demo2" name="demo2" style="text-align:center;width:300px;font-size:45px;font-weight:bold;background-color:#b6bdc6;" disabled>
                                                </div>
                                            </td>
                                        </tr>
                    </div>
                    ...
                    <input class="hidden" type="text" name="Inverter40Qty" id="Inverter40Qty" style="font-size:25px;width:200px;text-align:center" />
                    <input class="hidden" type="text" name="Inverter59Qty" id="Inverter59Qty" style="font-size:25px;width:200px;text-align:center" />
                    <span class="hidden" id="email6-availability-status"></span>
                        ...
                        <form id="myForm">
                            <table class="table table-condensed" border="2" style="background-color:aliceblue;width:100%;border-style:solid">
                                <thead>
                                    <div data-role="header" class="" id="FireAlarmAboveWindow">
                                        <th colspan="6">
                                            <h1>CHECKING of SOLAR SOCKET</h1>
                                        </th>
                                    </div>
                                </thead>
                                <tbody>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" name="powerqty" id="powerqty" value="" style="font-size:30px;width:100px;text-align:center;color:black;font-weight:bold;background-color:#b6bdc6;" readonly="readonly" /><br>
                                                        <input class="hide" type="text" name="powercon_3" id="powercon_3" style="font-size:25px;width:100px;text-align:center" />
                                                        <input class="hide" type="text" name="powercon_4" id="powercon_4" style="font-size:25px;width:100px;text-align:center" />
                                                        <input class="hide" type="text" name="powercon_5" id="powercon_5" style="font-size:25px;width:100px;text-align:center" />
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div class="col-sm-12" align="center">
                                                <input class="blink_me" type="text" name="hybrid" id="hybrid" style="border: none;background:transparent;font-size:40px;width:350px;text-align:center;float:left;margin-top:5px;color:blue;" readonly />
                                                ...
                                                <input type="text" id="demosolar" name="demosolar" style="text-align:center;width:300px;font-size:45px;font-weight:bold;background-color:#b6bdc6;" disabled>
                                            </div>
                    </div>
                    </td>
                    <span class="hidden" id="email6-availability-status"></span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-sm-8" align="center">
                                                <!--<input class="bg-danger" type="button" onclick="myFunction()" value="Clear Form" style="font-size:25px;color:black;font-weight:bold;float:left;" >-->
                                                <label style="font-size:45px;color:red;" class="space">Result:</label>
                                                <input type="text" id="b_result" name="b_result" style="text-align:center;width:300px;font-size:45px;font-weight:bold;background-color:#b6bdc6;" disabled>
