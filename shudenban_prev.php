						...
						<tbody>
							...
							<form method="post" action="">
								...
								<label style="font-size:25px;color:black">Customer Code:</label>
									<input type="" name="code_number" id="code_number" onkeypress="kva_check1()" onkeyup="kva_check1()"   style="font-size:20px;width:200px;text-align:center" maxlength="12"   />
							...
							<!--<div id="content"></div>-->
								...
								<td class="form-inline" colspan="6" style="text-align:center;vertical-align:middle;">										  					 											
									...
									<label style="font-size:25px;color:black;" class="space">		Result:</label>									
										<input type="text" id="demo" style="width:520px;font-size:30px;font-weight:bold;border:none;background-color:#F0F8FF;" disabled>			
								</td>												
							</tr>
							<tr>
								<td>
	 ...
	 function compute() {
              ...
              /////////////////////////////////////////////////////////////
				...
				//////////////////////////////////////////////
					...
					document.getElementById("demo").style.color = "green";
					///////////////For PDR//////////////
				} /* else if(KVA == '' && electric_company == '' && powercon_1 == '5.5kW' && powercon_2 == '5.5kW' || powercon_1 == '5.5kW' && powercon_2 == '8.0kW' || powercon_1 == '5.5kW' && powercon_2 == '9.9kW' || powercon_1 == '8.0kW' && powercon_2 == '8.0kW' ){
					...
					/* document.getElementById("demo").value = results6;
					document.getElementById("demo").style.color = "red"; */
				}
