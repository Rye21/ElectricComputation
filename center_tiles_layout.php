							...
							<tr height="250px">
								...
								<td style="vertical-align:middle;width:500px">
									...
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black"  onchange="checkemailAvailability(),setTimeout(compute, 500)"  id="exterior_denki"  name="exterior_denki"  required="required">
											<option value=""></option>   
									...
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="checkemailAvailability(),setTimeout(compute, 500)" id="standard"  name="standard"  required="required">
									...
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>								
										<input type="text" id="R_height" name="R_height"  onchange="checkemailA()" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"  >				
								...
								<td style="text-align:center;vertical-align:middle;background-color:">										  					 											
									<input type="text" id="center_tiles" name="center_tiles" align="center" style="height:200px;width:200px;font-size:60px;color:red;text-align:center" readonly><br>
									<label style="font-size:25px;color:black;color:red" class="space">Items Height to Use</label>									
					...
					<table id="table2" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm2">		
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="checkemailAvailability1(),setTimeout(compute2, 500)" id="exterior_denki1"  name="exterior_denki1"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<?php	
									...
									<br>
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="checkemailAvailability1(),setTimeout(compute2, 500)" id="standard1"  name="standard1"  required="required">
											 <option disabled selected>Choose Type</option>
									...
									<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height1" name="R_height1" onchange="checkemail1A()" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
								...
								<td style="text-align:center;vertical-align:middle;background-color:">										  					 											
									<input type="text" id="center_tiles1" name="center_tiles1" align="center" style="height:200px;width:200px;font-size:60px;color:red;text-align:center" readonly><br>
									<label style="font-size:25px;color:black;color:red" class="space">Items Height to Use</label>																	
								</td>
								<td style="vertical-align:middle;width:400px">										  					 											
										<b style="font-size:20px" class="space">Standard height  </b>									
					...
					<table id="table3" class="table table-condensed" border="2"	style="background-color:aliceblue;width:100%;border-style:solid">
						...
						<form id="myForm3">		
							<tr>
								...
								<td style="vertical-align:middle;width:500px">
									<label style="font-size:18px;color:black">Exterior Denki Items:</label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center;color:black" onchange="checkemailAvailability2(),setTimeout(compute3, 500)" id="exterior_denki2"  name="exterior_denki2"  required="required">
											<option value=""></option>
											<option><?php echo $option; ?></option>	
										</select>
									<br>	
									...
									?>	
									<label style="font-size:18px;color:black" class="space">Location:    		   </label>&nbsp;
										<select  style="height:50px;width:50%;font-size:25px;text-align:center" onchange="checkemailAvailability2()" id="standard2"  name="standard2"  required="required">
											 <option disabled selected>Choose Type</option>
										...
										<br>
									<label style="font-size:20px;color:black;" class="space">Requested Height:  </label>									
										<input type="text" id="R_height2" name="R_height2" onchange="checkemail2A()" style="height:50px;width:50%;font-size:25px;color:blue;text-align:center"   >				
								...
								<td style="text-align:center;vertical-align:middle;background-color:">										  					 											
									<input type="text" id="center_tiles2" name="center_tiles2" align="center" style="height:200px;width:200px;font-size:60px;color:red;text-align:center" readonly><br>
									<label style="font-size:25px;color:black;color:red" class="space">Items Height to Use</label>																	
								</td>
